...
On the other hand, _prism.cnv_ includes gene copy number (CN) values by gene (column). Normally, CN is 2, since there are two alleles per genes. In cancer however, genes might be amplified CN > 2 or deleted CN < 2. 
```{r}
head(prism.cnv)
```
